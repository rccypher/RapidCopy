...
./wait-for-it.sh myapp:8800 -- echo "RapidCopy app is up (before configuring)"
...
./wait-for-it.sh myapp:8800 -- echo "RapidCopy app is up (after configuring)"

echo
echo "Done configuring RapidCopy app"
